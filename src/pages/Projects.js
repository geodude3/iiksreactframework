...
function Projects() {
    return (
        <div className="body">
            <h1>Welcome to IIKS Research</h1>
            <div>
            ...
            <img id="EHD1" className="img" src={EHD1} alt="EHD1"></img>
            <img id="EHD2" className="img" src={EHD2} alt="EHD2"></img>
            <img id="EHD3" className="img" src={EHD3} alt="EHD3"></img>
