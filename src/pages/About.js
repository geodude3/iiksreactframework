...
function About() {
    return (
        <div className="body">
            <div id="links">
                <Link className='menuElement' to="/projects"><button className='btn btn-danger btn-lg'>IIKS Research</button></Link>
            ...
            <p>
                ...
                Our operations, ranging from airline management to our contributions in the EHD propulsion sector, are very diverse.
